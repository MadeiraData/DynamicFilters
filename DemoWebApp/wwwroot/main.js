...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.changeResponseTab = function (newtab) {
        this.currResponseTab = newtab;
    };
    AppComponent.prototype.isCurrentTab = function (mytab) {
        return (mytab == this.currResponseTab);
    };
    AppComponent.prototype.getActiveClassForTab = function (mytab) {
        if (mytab == this.currResponseTab)
            return "active";
        else
            return "";
    };
    AppComponent.prototype.getActiveClassForTabContent = function (mytab) {
        if (mytab == this.currResponseTab)
            return "show active";
        else
            return "";
...
module.exports = __webpack_require__(/*! C:\Users\user\Source\Repos\DynamicFilters\DemoWebApp\src\main.ts */"./src/main.ts");
